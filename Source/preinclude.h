...
#define TOUCHLINK_INTERNAL_ENDPOINT 5
...
// #defined(HAL_BOARD_VOFKINDT)

#if !defined(HAL_BOARD_FREEPAD_20) && !defined(HAL_BOARD_FREEPAD_12) && !defined(HAL_BOARD_FREEPAD_8) && !defined(HAL_BOARD_FREEPAD_3) && !defined(HAL_BOARD_FREEPAD_2) && !defined(HAL_BOARD_FREEPAD_1) && !defined(HAL_BOARD_CHDTECH_DEV) && !defined(HAL_BOARD_VOFKINDT)
...
#define FREEPAD_BUTTONS_COUNT 4
#endif
